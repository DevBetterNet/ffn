namespace Dev.Core.Caching;

/// <summary>
/// Represents default values related to caching entities
/// </summary>
public static partial class DevEntityCacheDefaults<TEntity> where TEntity : BaseEntity
{
    /// <summary>
    ...
    /// {0} : entity id
    /// </remarks>
    public static CacheKey ByIdCacheKey => new CacheKey($"Dev.{EntityTypeName}.byid.{{0}}", ByIdPrefix, Prefix);
    ...
    /// {0} : entity ids
    /// </remarks>
    public static CacheKey ByIdsCacheKey => new CacheKey($"Dev.{EntityTypeName}.byids.{{0}}", ByIdsPrefix, Prefix);

    /// <summary>
    /// Gets a key for caching all entities
    /// </summary>
    public static CacheKey AllCacheKey => new CacheKey($"Dev.{EntityTypeName}.all.", AllPrefix, Prefix);
