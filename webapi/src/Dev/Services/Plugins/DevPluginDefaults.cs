...
{
    public static class DevPluginDefaults
    {
        /// <summary>
        ...
        /// {0} : user identifier
        /// </remarks>
        public static CacheKey AdminNavigationPluginsCacheKey => new CacheKey("Dev.plugins.adminnavigation.{0}", AdminNavigationPluginsPrefix);

        /// <summary>
        /// Gets a key pattern to clear cache
        /// </summary>
        public static string AdminNavigationPluginsPrefix => "Dev.plugins.adminnavigation.";
    }
}