...
namespace Dev.Services.Plugins
{
    ...
    public partial class PluginDescriptor : PluginDescriptorBaseInfo, IDescriptor, IComparable<PluginDescriptor>
    {
        ...
        public PluginDescriptor()
        {
            ...
            LimitedToWebApps = new List<Guid>();
            LimitedToCustomerRoles = new List<Guid>();
        ...
        {
            var fileProvider = EngineContext.Current.Resolve<IDevFileProvider>();
            ...
            var filePath = fileProvider.Combine(fileProvider.GetDirectoryName(OriginalAssemblyFile), DevPluginDefaults.DescriptionFileName);
        ...
        /// </summary>
        [JsonProperty(PropertyName = "LimitedToWebApps")]
        public virtual IList<Guid> LimitedToWebApps { get; set; }
        ...
        public virtual IList<Guid> LimitedToCustomerRoles { get; set; }
